 ...
 * @method TenantProfileIncomeSourceDTO[] getIncomeSources()
 * @method bool                           hasIncomeSources()
 * @method TenantProfileVehicleDTO[]      getVehicles()
 * @method bool                           hasVehicles()
 * @method TenantProfileEmployerDTO[]     getEmployers()
 * @method bool                           hasEmployers()
 * @method TenantProfileDependentDTO[]    getDependents()
 * @method bool                           hasDependents()
 * @method TenantProfileRentalDTO[]       getRentals()
 * @method bool                           hasRentals()
 * @method TenantProfileContactDTO[]      getContacts()
 * @method bool                           hasContacts()
 * @method TenantProfilePetDTO[]          getPets()
 * @method bool                           hasPets()
